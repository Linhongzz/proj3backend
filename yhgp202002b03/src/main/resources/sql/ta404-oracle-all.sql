...
drop table TAACCESSDENYLOG cascade constraints;
...
drop table TAAUDIT cascade constraints;
...
drop table tadynamicrest cascade constraints;
drop table TAEXAMINE cascade constraints;
drop table TAEXAMINELOCKED cascade constraints;
drop table TAEXAMINECHILD cascade constraints;
drop table TAEXTENDSETTING cascade constraints;
drop table TAJOBDATASOURCEMG cascade constraints;
drop table TALOGINFAILLOG cascade constraints;
drop table TALOGINHISTORYLOG cascade constraints;
drop table TALOGINSTATLOG cascade constraints;
DROP TABLE TAMSGNOTICE CASCADE CONSTRAINTS;
DROP TABLE TAMSGNOTICESTATE CASCADE CONSTRAINTS;
DROP TABLE TAMSGNOTICEANNEX CASCADE CONSTRAINTS;
DROP TABLE TAMSGCHAT CASCADE CONSTRAINTS;
DROP TABLE TAMSGLETTER CASCADE CONSTRAINTS;
...
drop table TASYSCONFIG cascade constraints;
drop table TATAG cascade constraints;
drop table TATAGGROUP cascade constraints;
DROP TABLE taurl cascade constraints;
...
DROP TABLE tauserconnection cascade constraints;
-- drop end
...
(
    ...
    protectprivacyrule VARCHAR2(20),
...
(
    ...
    datatype        VARCHAR2(1),
    functiontype    VARCHAR2(1),
    collectionname  VARCHAR2(100),
    collectiondatas VARCHAR2(2000),
    flag            DECIMAL(10, 0),
    configcomment   VARCHAR2(1024),
    createtime      DATE,
    updatetime      DATE,
    opuserid        VARCHAR2(36),
    opusername      VARCHAR2(36),
    constraint pk_tasysconfig primary key (id)
);
...
CREATE TABLE "TAUSERCONNECTION" (
                                    ...
                                    providerId NVARCHAR2(255) NOT NULL ,
                                    providerUserId NVARCHAR2(255) NOT NULL ,
                                    rank NUMBER(11) NOT NULL ,
                                    displayName NVARCHAR2(255) ,
                                    profileUrl NVARCHAR2(512) ,
                                    imageUrl NVARCHAR2(512) ,
                                    accessToken NVARCHAR2(512) NOT NULL ,
                                    secret NVARCHAR2(512) ,
                                    refreshToken NVARCHAR2(512) ,
                                    expireTime NUMBER(20)
);

ALTER TABLE "TAUSERCONNECTION" ADD CONSTRAINT "SYS_C00187601" PRIMARY KEY (userId, providerId, providerUserId);
...
CREATE OR REPLACE VIEW V_RESOURCECATEGORY(CATEGORYID, CATEGORYNAME, EFFECTIVE, CODE, CATEGORYCONTENT) AS
...
CREATE OR REPLACE VIEW V_CUSTOMRESOURCE(CUSTOMRESOURCEID, RESOURCENAME, PARENTID, CODE, RESOURCECONTENT, RESOURCECATEGORY, EFFECTIVE, ADDTIME, MODIFYTIME, SYSTEM) AS
...
--  初始化人员表
INSERT INTO tauser(userid, loginid, password, passworddefaultnum, pwdlastmodifydate, islock, orderno, name, sex, idcardtype, idcardno, mobile, createuser, createtime, modifytime, destory, accountsource, effective, effectivetime, jobnumber, state, birthplace, address, zipcode, email, phone, education, graduateschool, workplace, field01, field02, field03, field04, field05, field06, field07, field08, field09, field10) VALUES ('1', 'developer', '$2a$10$ZI3ewI1LvnS8bvTDiZk5X.w9/u.LXy8vPTwQFl8SlDtMTYBQHnIEm', 0, sysdate, '0', 1, '超级管理员','1', '0', null, '18011567700', '1', sysdate, NULL, '0', NULL, '1', NULL, NULL, NULL, NULL, '成都市/锦江区/久远银海', NULL,NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO tauser(userid, loginid, password, passworddefaultnum, pwdlastmodifydate, islock, orderno, name, sex, idcardtype, idcardno, mobile, createuser, createtime, modifytime, destory, accountsource, effective, effectivetime, jobnumber, state, birthplace, address, zipcode, email, phone, education, graduateschool, workplace, field01, field02, field03, field04, field05, field06, field07, field08, field09, field10) VALUES ('3', 'auditor', '$2a$10$ZI3ewI1LvnS8bvTDiZk5X.w9/u.LXy8vPTwQFl8SlDtMTYBQHnIEm', 0, sysdate, '0', 21, '审计默认管理员', '1', NULL, NULL, NULL, '1', sysdate, NULL, '0', NULL, '1', NULL, NULL, NULL, NULL, '成都市/锦江区/久远银海', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--  初始化组织表
INSERT INTO taorg
(orgid, orgname, spell, parentid, idpath, namepath, customno, orderno, orglevel, area, effective, orgtype, createuser,
 createtime, modifytime, orgmanager, orgcode, contacts, address, tel, destory, field01, field02, field03, field04,
 field05, field06, field07, field08, field09, field10)
VALUES ('fd811ab9c30440088df3e29ea784460a', '顶级组织', 'MZB', '0', 'fd811ab9c30440088df3e29ea784460a', '顶级组织', '', 0, 0,
        '', '1', '01', '1', NULL, sysdate, '', '', '', '', '', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL);
...
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, system, newtype) VALUES ('操作类型', 'OPTYPE', '修改密码', '43', NULL, 420, '0', NULL, NULL, NULL, sysdate, '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
...
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, system, newtype) VALUES ('性别', 'SEX', '男', '1', NULL, 10, '0', NULL, NULL, NULL, sysdate, '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, system, newtype) VALUES ('性别', 'SEX', '女', '2', NULL, 20, '0', NULL, NULL, NULL, sysdate, '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, system, newtype) VALUES ('性别', 'SEX', '无', '0', NULL, 30, '0', NULL, NULL, NULL, sysdate, '1', '1', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
...
INSERT INTO taresource(resourceid, presourceid, name, code, syscode, url, orderno, idpath, namepath, resourcelevel, icon, iconcolor, securitypolicy, securitylevel, resourcetype, effective, isdisplay, isfiledscontrol, createdate, createuser, uiauthoritypolicy, field01, field02, field03, field04, field05, field06, field07, field08, field09, field10, workbench, image) VALUES ('40337bdecb19484ebeb39d6c21aaca26', '0', '银海软件', '', 'sysmg', '', 0, '40337bdecb19484ebeb39d6c21aaca26', '银海软件', '0', '', '', '2', 1, '0', '1', '', '', sysdate, '1', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL);
